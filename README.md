...
## Dashboard preview 
![Dashboard](MTN_dashboard.png)


## Data Source
*Simulated dataset representing MTN customer activities, subscription plans, churn status, device usage, and satisfaction ratings.*
